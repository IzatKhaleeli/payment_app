...
class LOVCompareService {
  ...
  static Future<void> compareAndSyncCurrencies() async {
    try {
      ...
      List<Map<String, dynamic>> remoteCurrenciesData =
          remoteCurrencies.map((currency) => currency.toMap()).toList();
      ...
      for (var remoteData in remoteCurrenciesData) {
        ...
        //   print(
        //       'Currency{id: ${currency['id']}, arabicName: ${currency['arabicName']}, englishName: ${currency['englishName']}}');
        // }
      }
    } catch (e) {
  ...
  static Future<void> compareAndSyncBanks() async {
    try {
      ...
      List<Map<String, dynamic>> remoteBanksData =
          remoteBanks.map((bank) => bank.toMap()).toList();
