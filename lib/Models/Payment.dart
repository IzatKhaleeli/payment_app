...
class Payment {
  ...
  factory Payment.fromMap(Map<String, dynamic> map) {
    return Payment(
      ...
      lastUpdatedDate: (map['lastUpdatedDate'] != 'null' &&
              map['lastUpdatedDate'] != '' &&
              map['lastUpdatedDate'] != null)
          ? DateTime.parse(map['lastUpdatedDate'])
          : null,
      ...
      msisdn: (map['msisdn'] != null && map.containsKey('msisdn'))
          ? map['msisdn']
          : null,
      msisdnReceipt:
          (map['msisdnReceipt'] != null && map.containsKey('msisdnReceipt'))
              ? map['msisdnReceipt']
              : null,
      prNumber: (map['prNumber'] != null && map.containsKey('prNumber'))
          ? map['prNumber']
          : null,
      amount: (map['amount'] != null && map.containsKey('amount'))
          ? map['amount']
          : null,
      amountCheck:
          (map['amountCheck'] != null && map.containsKey('amountCheck'))
              ? map['amountCheck']
              : null,
      checkNumber:
          (map['checkNumber'] != null && map.containsKey('checkNumber'))
              ? map['checkNumber']
              : null,
      bankBranch: (map['bankBranch'] != null && map.containsKey('bankBranch'))
          ? map['bankBranch']
          : null,
      dueDateCheck: (map['dueDateCheck'] != 'null' && map['dueDateCheck'] != '')
          ? DateTime.parse(map['dueDateCheck'])
          : null,
      currency: (map['currency'] != null && map.containsKey('currency'))
          ? map['currency']
          : null,
      paymentInvoiceFor: (map['paymentInvoiceFor'] != null &&
              map.containsKey('paymentInvoiceFor'))
          ? map['paymentInvoiceFor']
          : null,
      cancelReason:
          (map['cancelReason'] != null && map.containsKey('cancelReason'))
              ? map['cancelReason']
              : null,
      cancellationDate: (map['cancellationDate'] != 'null' &&
              map['cancellationDate'] != '' &&
              map['cancellationDate'] != null)
  ...
  @override
  String toString() {
    return 'Payment(voucherSerialNumber: $voucherSerialNumber, '
        'customerName: $customerName, msisdn: $msisdn, '
        'msisdnReceipt: $msisdnReceipt, prNumber: $prNumber, '
        'paymentMethod: $paymentMethod, amount: $amount, '
        'amountCheck: $amountCheck, checkNumber: $checkNumber, '
        'bankBranch: $bankBranch, dueDateCheck: $dueDateCheck, '
        'currency: $currency, paymentInvoiceFor: $paymentInvoiceFor, '
