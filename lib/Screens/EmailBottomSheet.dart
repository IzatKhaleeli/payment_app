                          ...
                          onPressed: () async {
                            ...
                            if(_errorText ==null) {
                              ...
                              String emailBody = "<html>\n"
                                  + "<body style=\"font-family: Arial, sans-serif; margin: 0; padding: 0; max-width: 975px; align=${direction == 'rtl' ? 'right' : 'left'};\">\n"
                                  + "    <!-- Header Image -->\n"
                                  + "    <table role=\"presentation\" style=\"width: 100%; border: 0; cellpadding: 0; cellspacing: 0;\">\n"
                                  + "        <tr>\n"
                                  + "            <td style=\"padding: 10px 0;\">\n"
                                  + "                <img src=\"cid:headerImageCID\" alt=\"Header Image\" style=\"width: 100%; height: auto; display: block;\"/>\n"
                                  + "            </td>\n"
                                  + "        </tr>\n"
                                  + "    </table>\n"
                                  + "    <!-- Email Content -->\n"
                                  + "    <br/>\n"
                                  + "    <table role=\"presentation\" style=\"width: 100%; max-width: 975px; border: 0; cellpadding: 0; cellspacing: 0; text-align: ${direction == 'rtl' ? 'right' : 'left'}; direction: ${direction};\">\n"
                                  + "        <tr>\n"
                                  ...
                                  + "    </table>\n"
                                  + "    <br/>\n"
                                  + "    <div style=\"font-family: Arial, sans-serif; margin: 0; padding: 0; width: 100%; max-width: 975px; background-color: #f0f0f0;\">\n"
                                  ...
                                  + "                    <p style=\"max-width: 975px;\">The information in this email may contain confidential material and it is intended solely for the addresses. Access to this email by anyone else is unauthorized. If you are not the intended recipient, please delete the email instantly.</p>\n"
                                  + "                </td>\n"
                                  ...
                                  + "                    <p style=\"max-width: 975px;\">قد يحتوي هذا البريد الإلكتروني على مواد سرية. الحصول على هذه الرسالة من قبل أي شخص آخر، هو شيء غير مصرح به. إذا لم تكن المتلقي المقصود، يرجى حذف هذا البريد الإلكتروني على الفور.</p>\n"
                                  + "                </td>\n"
                                  + "            </tr>\n"
                                  + "        </table>\n"
                                  + "    </div>\n"
